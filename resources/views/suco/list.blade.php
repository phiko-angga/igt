...
@section('page_header_right')
    <a href="{{url('master/suco/create')}}" class="btn btn-primary btn-fw">Add new</a>
@endsection
...
<script>
    ...
    $(document).on('change','#search', function(){
        fetch_tabledata('/master/suco');
    })

    $('.delete_btn').click(function(e){
        e.preventDefault();
        var modalConfirm = $('#modal_confirm');
        modalConfirm.find('form').attr('action',"{{url('master/suco')}}/"+$(this).data('id'));
        modalConfirm.find('#confirm_title').html('Delete suco ');
        modalConfirm.find('#confirm_titlecaption').html('Are you sure delete suco ');
